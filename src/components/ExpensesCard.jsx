export const ExpensesCard = ({ price }) => {
  return (
    <div className="w-[384px] h-[220px] bg-white rounded-xl	">
      <div className="flex items-center py-4 px-6 gap-2 border-b border-[#E2E8F0]">
        <div className=" bg-[#0166FF] rounded-full w-2 h-2"></div>
        <div className="font-semibold ">Total Expenses</div>
      </div>
      <div className="pt-5 pb-6 px-6 flex flex-col gap-4">
        <div>
          <div className="text-4xl font-semibold mb-1">{price} ₮</div>
        ...
        <div className="flex gap-2 items-center">
          ...
          <div className="text-lg">32% from last month</div>
        </div>
      </div>
    </div>
  );
